...
#line 43 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_pwr_ex.c"
...
#line 67 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_pwr_ex.c"
...
uint32_t HAL_PWREx_GetVoltageRange(void)
{
#line 148 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_pwr_ex.c"
  return  (((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR1 & (0x3UL << (9U)));
...
#line 254 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_pwr_ex.c"

   
  if (VoltageScaling == (0x1UL << (9U)))
  {
    if (((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR1) & ((0x3UL << (9U)))) != (0x1UL << (9U)))
    {
...
void HAL_PWREx_EnableVddUSB(void)
{
  ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR2) |= ((0x1UL << (10U))));
}
...
void HAL_PWREx_EnableVddIO2(void)
{
  ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR2) |= ((0x1UL << (9U))));
}
...
HAL_StatusTypeDef HAL_PWREx_EnableGPIOPullUp(uint32_t GPIO, uint32_t GPIONumber)
{
  ...
  switch (GPIO)
  {
    ...
    case 0x00000005U:
       ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->PUCRF) |= (GPIONumber));
       ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->PDCRF) &= ~(GPIONumber));
       break;


    case 0x00000006U:
       ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->PUCRG) |= (GPIONumber));
       ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->PDCRG) &= ~(GPIONumber));
       break;

    case 0x00000007U:
       ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->PUCRH) |= ((GPIONumber & ((uint32_t)0x00000003))));



       ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->PDCRH) &= ~((GPIONumber & ((uint32_t)0x00000003))));

       break;
#line 467 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_pwr_ex.c"
    default:
      status = HAL_ERROR;
      break;
  }
...
HAL_StatusTypeDef HAL_PWREx_EnableGPIOPullDown(uint32_t GPIO, uint32_t GPIONumber)
{
  ...
  switch (GPIO)
  {
    ...
    case 0x00000007U:
       ...
       ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->PUCRH) &= ~((GPIONumber & ((uint32_t)0x00000003))));
       break;
#line 627 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_pwr_ex.c"
    default:
      status = HAL_ERROR;
      break;
  }
...
#line 786 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_pwr_ex.c"


#line 812 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_pwr_ex.c"


#line 838 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_pwr_ex.c"

#line 859 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_pwr_ex.c"
...
HAL_StatusTypeDef HAL_PWREx_ConfigPVM(PWR_PVMTypeDef *sConfigPVM)
{
  ...
  switch (sConfigPVM->PVMType)
  {
    ...
    case (0x1UL << (4U)):
      ...
      ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->EMR2) &= ~(((uint32_t)0x00000008)));
      ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->IMR2) &= ~(((uint32_t)0x00000008)));
      ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->FTSR2) &= ~(((uint32_t)0x00000008)));
      ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->RTSR2) &= ~(((uint32_t)0x00000008)));

       
      if((sConfigPVM->Mode & ((uint32_t)0x00010000)) == ((uint32_t)0x00010000))
      {
        ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->IMR2) |= (((uint32_t)0x00000008)));
      }

       
      if((sConfigPVM->Mode & ((uint32_t)0x00020000)) == ((uint32_t)0x00020000))
      {
        ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->EMR2) |= (((uint32_t)0x00000008)));
      }

       
      if((sConfigPVM->Mode & ((uint32_t)0x00000001)) == ((uint32_t)0x00000001))
      {
        ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->RTSR2) |= (((uint32_t)0x00000008)));
      }

      if((sConfigPVM->Mode & ((uint32_t)0x00000002)) == ((uint32_t)0x00000002))
      {
        ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->FTSR2) |= (((uint32_t)0x00000008)));
      }
      break;
    ...
    case (0x1UL << (5U)):
      ...
      ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->EMR2) &= ~(((uint32_t)0x00000010)));
      ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->IMR2) &= ~(((uint32_t)0x00000010)));
      ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->FTSR2) &= ~(((uint32_t)0x00000010)));
      ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->RTSR2) &= ~(((uint32_t)0x00000010)));
    ...
    case (0x1UL << (6U)):
      ...
      ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->EMR2) &= ~(((uint32_t)0x00000020)));
      ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->IMR2) &= ~(((uint32_t)0x00000020)));
      ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->FTSR2) &= ~(((uint32_t)0x00000020)));
      ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->RTSR2) &= ~(((uint32_t)0x00000020)));
    ...
    case (0x1UL << (7U)):
      ...
      ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->EMR2) &= ~(((uint32_t)0x00000040)));
      ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->IMR2) &= ~(((uint32_t)0x00000040)));
      ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->FTSR2) &= ~(((uint32_t)0x00000040)));
      ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->RTSR2) &= ~(((uint32_t)0x00000040)));
...
void HAL_PWREx_EnterSTOP0Mode(uint8_t STOPEntry)
{
  ...
  (((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR1)) = ((((((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR1))) & (~((0x7UL << (0U))))) | ((0x00000000UL)))));
...
void HAL_PWREx_EnterSTOP2Mode(uint8_t STOPEntry)
{
  ...
  (((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR1)) = ((((((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR1))) & (~((0x7UL << (0U))))) | ((0x1UL << (1U))))));
...
void HAL_PWREx_PVD_PVM_IRQHandler(void)
{
  ...
  if((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->PR1 & ((uint32_t)0x00010000)) != 0x0U)
  {
  ...
  if((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->PR2 & ((uint32_t)0x00000008)) != 0x0U)
  {
     
    HAL_PWREx_PVM1Callback();

     
    ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->PR2) = (((uint32_t)0x00000008)));
  }


  if((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->PR2 & ((uint32_t)0x00000010)) != 0x0U)
  {
     
    HAL_PWREx_PVM2Callback();

     
    ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->PR2) = (((uint32_t)0x00000010)));
  }

  if((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->PR2 & ((uint32_t)0x00000020)) != 0x0U)
  {
     
    HAL_PWREx_PVM3Callback();

     
    ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->PR2) = (((uint32_t)0x00000020)));
  }
  if((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->PR2 & ((uint32_t)0x00000040)) != 0x0U)
  {
     
    HAL_PWREx_PVM4Callback();

     
    ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->PR2) = (((uint32_t)0x00000040)));
  }
}
