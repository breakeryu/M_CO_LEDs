...
void LED_Init(void)
{
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x0080) | ((uint16_t)0x0100) | ((uint16_t)0x0200);
    GPIO_InitStruct.Mode = (0x00000001u);
    GPIO_InitStruct.Pull = (0x00000001u);
    GPIO_InitStruct.Speed = (0x00000002u);
    HAL_GPIO_Init(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1000UL)), &GPIO_InitStruct);

    HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1000UL)), ((uint16_t)0x0080) | ((uint16_t)0x0100) | ((uint16_t)0x0200), GPIO_PIN_SET);
}
...
{
	LED_Init();
	debug_LEDs_System_Init();
}

void m_led_Process(void)
{
	debug_LEDs_System_Run();
}


void aLedsRun (void)
{
	((((mLEDs)->LEDred & CO_LED_CANopen) ? 1 : 0)?HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1000UL)),((uint16_t)0x0080),GPIO_PIN_SET):HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1000UL)),((uint16_t)0x0080),GPIO_PIN_RESET));
	((((mLEDs)->LEDgreen & CO_LED_CANopen) ? 1 : 0)?HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1000UL)),((uint16_t)0x0100),GPIO_PIN_SET):HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1000UL)),((uint16_t)0x0100),GPIO_PIN_RESET));
}
