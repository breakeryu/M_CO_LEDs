...
#line 53 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal.c"
...
#line 78 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal.c"
...
HAL_StatusTypeDef HAL_Init(void)
{
  ...
  HAL_NVIC_SetPriorityGrouping(((uint32_t)0x00000005));
...
uint32_t HAL_GetHalVersion(void)
{
  return (((0x01U) << 24U) |((0x09U) << 16U) |((0x00U) << 8U) |((0x00U)));
}
...
uint32_t HAL_GetREVID(void)
{
  return((((DBGMCU_TypeDef *) (0xE0042000UL))->IDCODE & (0xFFFFUL << (16U))) >> 16);
}
...
uint32_t HAL_GetUIDw1(void)
{
  return(((*((uint32_t *)((0x1FFF7590UL) + 4U)))));
}
...
uint32_t HAL_GetUIDw2(void)
{
  return(((*((uint32_t *)((0x1FFF7590UL) + 8U)))));
}
...
void HAL_SYSCFG_SRAM2Erase(void)
{
  ...
  *(volatile uint32_t *) ((0x42000000UL) + ((((((0x40000000UL) + 0x00010000UL) + 0x0000UL) - (0x40000000UL)) + 0x18U) * 32U) + (0U * 4U)) = 0x00000001UL;
}
...
void HAL_SYSCFG_EnableMemorySwappingBank(void)
{
  *(volatile uint32_t *)((0x42000000UL) + (((((0x40000000UL) + 0x00010000UL) + 0x0000UL) - (0x40000000UL)) * 32U) + (8U * 4U)) = 0x00000000UL;
}
...
void HAL_SYSCFG_VREFBUF_VoltageScalingConfig(uint32_t VoltageScaling)
{
  ...
  (((((VREFBUF_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0030UL))->CSR)) = ((((((((VREFBUF_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0030UL))->CSR))) & (~((0x1UL << (2U))))) | (VoltageScaling))));
}
...
HAL_StatusTypeDef HAL_SYSCFG_EnableVREFBUF(void)
{
  ...
  while(((((VREFBUF_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0030UL))->CSR) & ((0x1UL << (3U)))) == 0U)
  {
