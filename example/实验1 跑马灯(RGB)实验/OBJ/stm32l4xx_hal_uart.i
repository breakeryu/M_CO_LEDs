...
#line 174 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_uart.c"
...
#line 199 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_uart.c"

#line 206 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_uart.c"
...
#line 362 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_uart.c"
...
#line 429 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_uart.c"
...
#line 517 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_uart.c"
...
#line 603 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_uart.c"
...
#line 680 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_uart.c"
...
#line 995 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_uart.c"
...
HAL_StatusTypeDef HAL_UART_Receive(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if (huart->RxState == HAL_UART_STATE_READY)
  {
    ...
    do { if ((huart)->Init . WordLength == (0x1UL << (12U))) { if ((huart)->Init . Parity == 0x00000000U) { (huart)->Mask = 0x01FFU ; } else { (huart)->Mask = 0x00FFU ; } } else if ((huart)->Init . WordLength == 0x00000000U) { if ((huart)->Init . Parity == 0x00000000U) { (huart)->Mask = 0x00FFU ; } else { (huart)->Mask = 0x007FU ; } } else if ((huart)->Init . WordLength == (0x1UL << (28U))) { if ((huart)->Init . Parity == 0x00000000U) { (huart)->Mask = 0x007FU ; } else { (huart)->Mask = 0x003FU ; } } } while(0U);
    uhMask = huart->Mask;
...
#line 1278 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_uart.c"
    {
...
#line 1365 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_uart.c"
    {
...
HAL_StatusTypeDef HAL_UART_DMAPause(UART_HandleTypeDef *huart)
{
  ...
  if ((huart->gState == HAL_UART_STATE_BUSY_TX) &&
      ((((huart->Instance ->CR3) & ((0x1UL << (7U)))) == ((0x1UL << (7U))))))
  {
     
    ((huart->Instance ->CR3) &= ~((0x1UL << (7U))));
  }
  if ((huart->RxState == HAL_UART_STATE_BUSY_RX) &&
      ((((huart->Instance ->CR3) & ((0x1UL << (6U)))) == ((0x1UL << (6U))))))
  {
...
#line 1703 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_uart.c"

   
  ((huart)->Instance ->RQR |= ((0x1UL << (3U))));
...
#line 1766 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_uart.c"
...
#line 1958 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_uart.c"
...
#line 2058 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_uart.c"
...
void HAL_UART_IRQHandler(UART_HandleTypeDef *huart)
{
  ...
  if (errorflags == RESET)
  {
    ...
    if (((isrflags & (0x1UL << (5U))) != RESET)
        && ((cr1its & (0x1UL << (5U))) != RESET))
  ...
  if (((isrflags & (0x1UL << (20U))) != RESET) && ((cr3its & (0x1UL << (22U))) != RESET))
  {
  ...
  if (((isrflags & (0x1UL << (7U))) != RESET)
      && ((cr1its & (0x1UL << (7U))) != RESET))
...
#line 2418 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_uart.c"
}
...
#line 2780 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_uart.c"
  ...
  if (((((huart)->Instance) == ((USART_TypeDef *) ((0x40000000UL) + 0x8000UL)))))
  {
    ...
    switch (clocksource)
    {
      ...
      case UART_CLOCKSOURCE_HSI:
        ...
        lpuart_ker_ck_pres = (uint32_t)((uint32_t)16000000U);
      ...
      case UART_CLOCKSOURCE_LSE:
        ...
        lpuart_ker_ck_pres = (uint32_t)((uint32_t)32768U);
      ...
      else
      {
        switch (clocksource)
        {
          case UART_CLOCKSOURCE_PCLK1:
            ...
            usartdiv = (uint32_t)((((((uint64_t)(HAL_RCC_GetPCLK1Freq())*256U)) + ((huart->Init . BaudRate)/2U)) / (huart->Init . BaudRate)));
          ...
          case UART_CLOCKSOURCE_HSI:
            ...
            usartdiv = (uint32_t)((((((uint64_t)(((uint32_t)16000000U))*256U)) + ((huart->Init . BaudRate)/2U)) / (huart->Init . BaudRate)));
          ...
          case UART_CLOCKSOURCE_SYSCLK:
            ...
            usartdiv = (uint32_t)((((((uint64_t)(HAL_RCC_GetSysClockFreq())*256U)) + ((huart->Init . BaudRate)/2U)) / (huart->Init . BaudRate)));
          ...
          case UART_CLOCKSOURCE_LSE:
            ...
            usartdiv = (uint32_t)((((((uint64_t)(((uint32_t)32768U))*256U)) + ((huart->Init . BaudRate)/2U)) / (huart->Init . BaudRate)));
  ...
  else if (huart->Init.OverSampling == (0x1UL << (15U)))
  {
    switch (clocksource)
    {
      case UART_CLOCKSOURCE_PCLK1:
        ...
        usartdiv = (uint16_t)(((((HAL_RCC_GetPCLK1Freq())*2U) + ((huart->Init . BaudRate)/2U)) / (huart->Init . BaudRate)));
      ...
      case UART_CLOCKSOURCE_PCLK2:
        ...
        usartdiv = (uint16_t)(((((HAL_RCC_GetPCLK2Freq())*2U) + ((huart->Init . BaudRate)/2U)) / (huart->Init . BaudRate)));
      ...
      case UART_CLOCKSOURCE_HSI:
        ...
        usartdiv = (uint16_t)(((((((uint32_t)16000000U))*2U) + ((huart->Init . BaudRate)/2U)) / (huart->Init . BaudRate)));
      ...
      case UART_CLOCKSOURCE_SYSCLK:
        ...
        usartdiv = (uint16_t)(((((HAL_RCC_GetSysClockFreq())*2U) + ((huart->Init . BaudRate)/2U)) / (huart->Init . BaudRate)));
      ...
      case UART_CLOCKSOURCE_LSE:
        ...
        usartdiv = (uint16_t)(((((((uint32_t)32768U))*2U) + ((huart->Init . BaudRate)/2U)) / (huart->Init . BaudRate)));
  ...
  else
  {
    switch (clocksource)
    {
      case UART_CLOCKSOURCE_PCLK1:
        ...
        usartdiv = (uint16_t)((((HAL_RCC_GetPCLK1Freq()) + ((huart->Init . BaudRate)/2U)) / (huart->Init . BaudRate)));
      ...
      case UART_CLOCKSOURCE_PCLK2:
        ...
        usartdiv = (uint16_t)((((HAL_RCC_GetPCLK2Freq()) + ((huart->Init . BaudRate)/2U)) / (huart->Init . BaudRate)));
      ...
      case UART_CLOCKSOURCE_HSI:
        ...
        usartdiv = (uint16_t)((((((uint32_t)16000000U)) + ((huart->Init . BaudRate)/2U)) / (huart->Init . BaudRate)));
      ...
      case UART_CLOCKSOURCE_SYSCLK:
        ...
        usartdiv = (uint16_t)((((HAL_RCC_GetSysClockFreq()) + ((huart->Init . BaudRate)/2U)) / (huart->Init . BaudRate)));
      ...
      case UART_CLOCKSOURCE_LSE:
        ...
        usartdiv = (uint16_t)((((((uint32_t)32768U)) + ((huart->Init . BaudRate)/2U)) / (huart->Init . BaudRate)));
...
#line 3492 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_uart.c"
...
#line 3580 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_uart.c"
...
#line 3769 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_uart.c"
...
#line 4043 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_uart.c"
