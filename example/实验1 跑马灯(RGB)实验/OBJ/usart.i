...
{
    while((((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3800UL))->ISR & 0X40) == 0); 

    ((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3800UL))->TDR = (u8) ch;
    return ch;
}
...
void uart_init(u32 bound)
{
    ...
    UART1_Handler.Instance = ((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3800UL));					  
    UART1_Handler.Init.BaudRate = bound;				  
    UART1_Handler.Init.WordLength = 0x00000000U; 
    UART1_Handler.Init.StopBits = 0x00000000U;	  
    UART1_Handler.Init.Parity = 0x00000000U;		  
    UART1_Handler.Init.HwFlowCtl = 0x00000000U; 
    UART1_Handler.Init.Mode = ((0x1UL << (3U)) |(0x1UL << (2U)));		  
    HAL_UART_Init(&UART1_Handler);					    

    (((((uint8_t)(0x0525U)) >> 5U) == 1U)? ((&UART1_Handler)->Instance ->CR1 |= (1U << ((0x0525U) & 0x001FU))): ((((uint8_t)(0x0525U)) >> 5U) == 2U)? ((&UART1_Handler)->Instance ->CR2 |= (1U << ((0x0525U) & 0x001FU))): ((&UART1_Handler)->Instance ->CR3 |= (1U << ((0x0525U) & 0x001FU)))); 
...
void HAL_UART_MspInit(UART_HandleTypeDef *huart)
{
    ...
    if(huart->Instance == ((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3800UL))) 
    {
        ...
        GPIO_Initure.Mode = (0x00000002u);		
        GPIO_Initure.Pull = (0x00000001u);			
        GPIO_Initure.Speed = (0x00000002u);		
        GPIO_Initure.Alternate = ((uint8_t)0x07);	
        HAL_GPIO_Init(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)), &GPIO_Initure);	   	

        GPIO_Initure.Pin = ((uint16_t)0x0400);				
        HAL_GPIO_Init(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)), &GPIO_Initure);	   	
    }
...
void USART1_IRQHandler(void)
{
    ...
    if(((((&UART1_Handler)->Instance ->ISR & ((0x1UL << (5U)))) == ((0x1UL << (5U)))) != RESET)) 
    {
