...
#line 107 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_dma.c"
...
#line 264 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_dma.c"
  ...
  if(hdma->Init.Direction != (0x1UL << (14U)))
  {
    ...
    if (((DMA_TypeDef *) (((0x40000000UL) + 0x00020000UL))) == hdma->DmaBaseAddress)
    {
       
      ((DMA_Request_TypeDef *) ((((0x40000000UL) + 0x00020000UL)) + 0x00A8UL))->CSELR &= ~((0xFUL << (0U)) << (hdma->ChannelIndex & 0x1cU));

       
      ((DMA_Request_TypeDef *) ((((0x40000000UL) + 0x00020000UL)) + 0x00A8UL))->CSELR |= (uint32_t) (hdma->Init.Request << (hdma->ChannelIndex & 0x1cU));
    }
    else  
    {
       
      ((DMA_Request_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x00A8UL))->CSELR &= ~((0xFUL << (0U)) << (hdma->ChannelIndex & 0x1cU));

       
      ((DMA_Request_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x00A8UL))->CSELR |= (uint32_t) (hdma->Init.Request << (hdma->ChannelIndex & 0x1cU));
    }
  }
...
HAL_StatusTypeDef HAL_DMA_DeInit(DMA_HandleTypeDef *hdma)
{
  ...
  hdma->DmaBaseAddress->IFCR = ((0x1UL << (0U)) << (hdma->ChannelIndex & 0x1cU));
...
#line 396 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_dma.c"
...
#line 542 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_dma.c"
...
#line 602 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_dma.c"
...
#line 658 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_dma.c"
...
HAL_StatusTypeDef HAL_DMA_PollForTransfer(DMA_HandleTypeDef *hdma, HAL_DMA_LevelCompleteTypeDef CompleteLevel, uint32_t Timeout)
{
  ...
  if (HAL_DMA_FULL_TRANSFER == CompleteLevel)
  {
    ...
    temp = (0x1UL << (1U)) << (hdma->ChannelIndex & 0x1cU);
  }
  else
  {
     
    temp = (0x1UL << (2U)) << (hdma->ChannelIndex & 0x1cU);
  }
  ...
  {
    if((0U != (hdma->DmaBaseAddress->ISR & ((0x1UL << (3U)) << (hdma->ChannelIndex& 0x1cU)))))
    {
...
#line 787 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_dma.c"

  if(HAL_DMA_FULL_TRANSFER == CompleteLevel)
  {
     
    hdma->DmaBaseAddress->IFCR = ((0x1UL << (1U)) << (hdma->ChannelIndex& 0x1cU));
  ...
  else
  {
    ...
    hdma->DmaBaseAddress->IFCR = ((0x1UL << (2U)) << (hdma->ChannelIndex & 0x1cU));
  }
...
void HAL_DMA_IRQHandler(DMA_HandleTypeDef *hdma)
{
  ...
  if ((0U != (flag_it & ((0x1UL << (2U)) << (hdma->ChannelIndex & 0x1cU)))) && (0U != (source_it & (0x1UL << (2U)))))
  {
  ...
  else if ((0U != (flag_it & ((0x1UL << (1U)) << (hdma->ChannelIndex & 0x1cU)))) && (0U != (source_it & (0x1UL << (1U)))))
  {
    if((hdma->Instance->CCR & (0x1UL << (5U))) == 0U)
    {
  ...
  else if ((0U != (flag_it & ((0x1UL << (3U)) << (hdma->ChannelIndex & 0x1cU)))) && (0U != (source_it & (0x1UL << (3U)))))
  {
...
static void DMA_SetConfig(DMA_HandleTypeDef *hdma, uint32_t SrcAddress, uint32_t DstAddress, uint32_t DataLength)
{
#line 1088 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_dma.c"
...
#line 1166 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_dma.c"
