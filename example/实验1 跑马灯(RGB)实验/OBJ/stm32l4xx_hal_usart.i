...
#line 156 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_usart.c"
...
#line 191 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_usart.c"
...
#line 328 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_usart.c"
  ...
  husart->Instance->CR2 &= ~(0x1UL << (14U));
  husart->Instance->CR3 &= ~((0x1UL << (5U)) | (0x1UL << (3U)) | (0x1UL << (1U)));
...
#line 387 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_usart.c"
...
#line 681 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_usart.c"
...
HAL_StatusTypeDef HAL_USART_Transmit(USART_HandleTypeDef *husart, uint8_t *pTxData, uint16_t Size, uint32_t Timeout)
{
  ...
  if (husart->State == HAL_USART_STATE_READY)
  {
    ...
    if ((husart->Init.WordLength == ((uint32_t)(0x1UL << (12U)))) && (husart->Init.Parity == 0x00000000U))
    {
      ptxdata8bits  = 0;
    ...
    {
      if (USART_WaitOnFlagUntilTimeout(husart, (0x1UL << (7U)), RESET, tickstart, Timeout) != HAL_OK)
      {
        return HAL_TIMEOUT;
      }
      if (ptxdata8bits == 0)
    ...
    if (USART_WaitOnFlagUntilTimeout(husart, (0x1UL << (6U)), RESET, tickstart, Timeout) != HAL_OK)
    {
      return HAL_TIMEOUT;
    }

     
    ((husart)->Instance ->ICR = ((0x1UL << (6U))));

     
    (((husart))->Instance ->ICR = ((0x1UL << (3U))));
    ((husart)->Instance ->RQR |= ((0x1UL << (3U))));
    ((husart)->Instance ->RQR |= ((0x1UL << (4U))));
...
HAL_StatusTypeDef HAL_USART_Receive(USART_HandleTypeDef *husart, uint8_t *pRxData, uint16_t Size, uint32_t Timeout)
{
  ...
  if (husart->State == HAL_USART_STATE_READY)
  {
    ...
    do { if ((husart)->Init . WordLength == ((uint32_t)(0x1UL << (12U)))) { if ((husart)->Init . Parity == 0x00000000U) { (husart)->Mask = 0x01FFU; } else { (husart)->Mask = 0x00FFU; } } else if ((husart)->Init . WordLength == 0x00000000U) { if ((husart)->Init . Parity == 0x00000000U) { (husart)->Mask = 0x00FFU; } else { (husart)->Mask = 0x007FU; } } else if ((husart)->Init . WordLength == ((uint32_t)(0x1UL << (28U)))) { if ((husart)->Init . Parity == 0x00000000U) { (husart)->Mask = 0x007FU; } else { (husart)->Mask = 0x003FU; } } else { (husart)->Mask = 0x0000U; } } while(0U);
    uhMask = husart->Mask;
    ...
    while (husart->RxXferCount > 0U)
    {
...

      {
        ...
        husart->Instance->TDR = (((uint16_t) 0xFFFF) & (uint16_t)0x0FF);
      }

       
      if (USART_WaitOnFlagUntilTimeout(husart, (0x1UL << (5U)), RESET, tickstart, Timeout) != HAL_OK)
      {
        return HAL_TIMEOUT;
      }
...
#line 955 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_usart.c"
...
#line 1174 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_usart.c"
    {
      ...
      (((((0x0727U) & 0x00E0U) >> 5U) == 1U)? ((husart)->Instance ->CR1 |= ((uint32_t)1U << ((0x0727U) & 0x001FU))): ((((0x0727U) & 0x00E0U) >> 5U) == 2U)? ((husart)->Instance ->CR2 |= ((uint32_t)1U << ((0x0727U) & 0x001FU))): ((husart)->Instance ->CR3 |= ((uint32_t)1U << ((0x0727U) & 0x001FU))));
    }
...
HAL_StatusTypeDef HAL_USART_Receive_IT(USART_HandleTypeDef *husart, uint8_t *pRxData, uint16_t Size)
{
  ...
  if (husart->State == HAL_USART_STATE_READY)
  {
    ...
    ((husart->Instance ->CR3) |= ((0x1UL << (0U))));

#line 1260 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_usart.c"
    {
      ...
      ((husart->Instance ->CR1) |= ((0x1UL << (8U)) | (0x1UL << (5U))));
...
#line 1300 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_usart.c"
      {
        husart->Instance->TDR = (((uint16_t) 0xFFFF) & (uint16_t)0x00FF);
      }
    }
...
#line 1377 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_usart.c"
    {
      if ((husart->Init.WordLength == ((uint32_t)(0x1UL << (12U)))) && (husart->Init.Parity == 0x00000000U))
      {
        husart->TxISR = USART_TxISR_16BIT;
...
HAL_StatusTypeDef HAL_USART_Receive_DMA(USART_HandleTypeDef *husart, uint8_t *pRxData, uint16_t Size)
{
  ...
  if (husart->State == HAL_USART_STATE_READY)
  {
...

    {
      ...
      if (husart->hdmatx != 0)
      {
        husart->hdmatx->XferErrorCallback = 0;
...
HAL_StatusTypeDef HAL_USART_TransmitReceive_DMA(USART_HandleTypeDef *husart, uint8_t *pTxData, uint8_t *pRxData, uint16_t Size)
{
  ...
  if (husart->State == HAL_USART_STATE_READY)
  {
    ...
    if ((husart->hdmarx != 0) && (husart->hdmatx != 0))
    {
...
HAL_StatusTypeDef HAL_USART_DMAPause(USART_HandleTypeDef *husart)
{
  ...
  if (((((husart->Instance ->CR3) & ((0x1UL << (7U)))) == ((0x1UL << (7U))))) &&
           ...
           (state == HAL_USART_STATE_BUSY_TX_RX))
  {
    ...
    if ((((husart->Instance ->CR3) & ((0x1UL << (6U)))) == ((0x1UL << (6U)))))
    {
...
HAL_StatusTypeDef HAL_USART_DMAStop(USART_HandleTypeDef *husart)
{
  ...
  if (husart->hdmatx != 0)
  {
    ...
    {
      if (HAL_DMA_GetError(husart->hdmatx) == 0x00000020U)
      {
  ...
  if (husart->hdmarx != 0)
  {
    ...
    {
      if (HAL_DMA_GetError(husart->hdmarx) == 0x00000020U)
      {
...
HAL_StatusTypeDef HAL_USART_Abort(USART_HandleTypeDef *husart)
{
  ...
  ((husart->Instance ->CR1) &= ~(((0x1UL << (5U)) | (0x1UL << (8U)) | (0x1UL << (7U)) | (0x1UL << (6U)))));
  ((husart->Instance ->CR3) &= ~((0x1UL << (0U))));
  ...
  ((husart)->Instance ->ICR = ((0x1UL << (3U)) | (0x1UL << (2U)) | (0x1UL << (0U)) | (0x1UL << (1U))));

#line 1972 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_usart.c"
...
#line 2111 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_usart.c"
...
void HAL_USART_IRQHandler(USART_HandleTypeDef *husart)
{
  uint32_t isrflags   = ((husart->Instance ->ISR));
...

  {
    ...
    {
      ((husart)->Instance ->ICR = (uint32_t)((0x1UL << (0U))));
    ...
    {
      ((husart)->Instance ->ICR = (uint32_t)((0x1UL << (1U))));
    ...
    {
      ((husart)->Instance ->ICR = (uint32_t)((0x1UL << (2U))));
    ...
    {
      ((husart)->Instance ->ICR = (uint32_t)((0x1UL << (3U))));

      husart->ErrorCode |= ((uint32_t)0x00000008U);
    }

#line 2239 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_usart.c"
    ...
    if (husart->ErrorCode != ((uint32_t)0x00000000U))
    {
      ...
      errorcode = husart->ErrorCode & ((uint32_t)0x00000008U);
      if (((((husart->Instance ->CR3) & ((0x1UL << (6U)))) == ((0x1UL << (6U))))) ||
          (errorcode != 0U))
      {
        ...
        if ((((husart->Instance ->CR3) & ((0x1UL << (6U)))) == ((0x1UL << (6U)))))
        {
          ((husart->Instance ->CR3) &= ~((0x1UL << (6U)) | (0x1UL << (6U))));
...
#line 2397 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_usart.c"
}
...
#line 2581 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_usart.c"
...
static void USART_DMATransmitCplt(DMA_HandleTypeDef *hdma)
{
  ...
  if ((((hdma->Instance ->CCR) & ((0x1UL << (5U)))) == 0U))
  {
    ...
    if (husart->State == HAL_USART_STATE_BUSY_TX)
    {
      ...
      (((((0x0626U) & 0x00E0U) >> 5U) == 1U)? ((husart)->Instance ->CR1 |= ((uint32_t)1U << ((0x0626U) & 0x001FU))): ((((0x0626U) & 0x00E0U) >> 5U) == 2U)? ((husart)->Instance ->CR2 |= ((uint32_t)1U << ((0x0626U) & 0x001FU))): ((husart)->Instance ->CR3 |= ((uint32_t)1U << ((0x0626U) & 0x001FU))));
    }
  }
...
static void USART_DMATxAbortCallback(DMA_HandleTypeDef *hdma)
{
  ...
  if (husart->hdmarx != 0)
  {
    if (husart->hdmarx->XferAbortCallback != 0)
    {
      return;
    }
  }
...
static void USART_DMARxAbortCallback(DMA_HandleTypeDef *hdma)
{
  ...
  if (husart->hdmatx != 0)
  {
    if (husart->hdmatx->XferAbortCallback != 0)
    {
      return;
    }
  }
...
static HAL_StatusTypeDef USART_WaitOnFlagUntilTimeout(USART_HandleTypeDef *husart, uint32_t Flag, FlagStatus Status, uint32_t Tickstart, uint32_t Timeout)
{
  ...
  while (((((husart)->Instance ->ISR & (Flag)) == (Flag)) ? SET : RESET) == Status)
  {
...
static HAL_StatusTypeDef USART_SetConfig(USART_HandleTypeDef *husart)
{
  ...
  tmpreg = (uint32_t)husart->Init.WordLength | husart->Init.Parity | husart->Init.Mode | (0x1UL << (15U));
  (((husart->Instance ->CR1)) = ((((((husart->Instance ->CR1))) & (~(((uint32_t)((0x10001UL << (12U)) | (0x1UL << (10U)) | (0x1UL << (9U)) | (0x1UL << (3U)) | (0x1UL << (2U)) | (0x1UL << (15U))))))) | (tmpreg))));
  ...
  tmpreg = (uint32_t)((0x1UL << (11U)));
  tmpreg |= (uint32_t)husart->Init.CLKLastBit;
  tmpreg |= ((uint32_t)husart->Init.CLKPolarity | (uint32_t)husart->Init.CLKPhase);
  tmpreg |= (uint32_t)husart->Init.StopBits;
  (((husart->Instance ->CR2)) = ((((((husart->Instance ->CR2))) & (~(((uint32_t)((0x1UL << (9U)) | (0x1UL << (10U)) | (0x1UL << (11U)) | (0x1UL << (8U)) | (0x3UL << (12U))))))) | (tmpreg))));

#line 2980 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_usart.c"

   
   
  do { if((husart)->Instance == ((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3800UL))) { switch((((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->CCIPR) & ((0x3UL << (0U)))))) { case 0x00000000U: (clocksource) = USART_CLOCKSOURCE_PCLK2; break; case (0x2UL << (0U)): (clocksource) = USART_CLOCKSOURCE_HSI; break; case (0x1UL << (0U)): (clocksource) = USART_CLOCKSOURCE_SYSCLK; break; case ((0x1UL << (0U)) | (0x2UL << (0U))): (clocksource) = USART_CLOCKSOURCE_LSE; break; default: (clocksource) = USART_CLOCKSOURCE_UNDEFINED; break; } } else if((husart)->Instance == ((USART_TypeDef *) ((0x40000000UL) + 0x4400UL))) { switch((((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->CCIPR) & ((0x3UL << (2U)))))) { case 0x00000000U: (clocksource) = USART_CLOCKSOURCE_PCLK1; break; case (0x2UL << (2U)): (clocksource) = USART_CLOCKSOURCE_HSI; break; case (0x1UL << (2U)): (clocksource) = USART_CLOCKSOURCE_SYSCLK; break; case ((0x1UL << (2U)) | (0x2UL << (2U))): (clocksource) = USART_CLOCKSOURCE_LSE; break; default: (clocksource) = USART_CLOCKSOURCE_UNDEFINED; break; } } else if((husart)->Instance == ((USART_TypeDef *) ((0x40000000UL) + 0x4800UL))) { switch((((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->CCIPR) & ((0x3UL << (4U)))))) { case 0x00000000U: (clocksource) = USART_CLOCKSOURCE_PCLK1; break; case (0x2UL << (4U)): (clocksource) = USART_CLOCKSOURCE_HSI; break; case (0x1UL << (4U)): (clocksource) = USART_CLOCKSOURCE_SYSCLK; break; case ((0x1UL << (4U)) | (0x2UL << (4U))): (clocksource) = USART_CLOCKSOURCE_LSE; break; default: (clocksource) = USART_CLOCKSOURCE_UNDEFINED; break; } } else { (clocksource) = USART_CLOCKSOURCE_UNDEFINED; } } while(0);
  ...
  switch (clocksource)
  {
    case USART_CLOCKSOURCE_PCLK1:
      ...
      usartdiv = (uint32_t)(((((HAL_RCC_GetPCLK1Freq())*2U) + ((husart->Init . BaudRate)/2U)) / (husart->Init . BaudRate)));
    ...
    case USART_CLOCKSOURCE_PCLK2:
      ...
      usartdiv = (uint32_t)(((((HAL_RCC_GetPCLK2Freq())*2U) + ((husart->Init . BaudRate)/2U)) / (husart->Init . BaudRate)));
    ...
    case USART_CLOCKSOURCE_HSI:
      ...
      usartdiv = (uint32_t)(((((((uint32_t)16000000U))*2U) + ((husart->Init . BaudRate)/2U)) / (husart->Init . BaudRate)));
    ...
    case USART_CLOCKSOURCE_SYSCLK:
      ...
      usartdiv = (uint32_t)(((((HAL_RCC_GetSysClockFreq())*2U) + ((husart->Init . BaudRate)/2U)) / (husart->Init . BaudRate)));
    ...
    case USART_CLOCKSOURCE_LSE:
      ...
      usartdiv = (uint32_t)(((((((uint32_t)32768U))*2U) + ((husart->Init . BaudRate)/2U)) / (husart->Init . BaudRate)));
...
static HAL_StatusTypeDef USART_CheckIdleState(USART_HandleTypeDef *husart)
{
  ...
  if ((husart->Instance->CR1 & (0x1UL << (3U))) == (0x1UL << (3U)))
  {
     
    if (USART_WaitOnFlagUntilTimeout(husart, (0x1UL << (21U)), RESET, tickstart, 1000U) != HAL_OK)
    {
  ...
  if ((husart->Instance->CR1 & (0x1UL << (2U))) == (0x1UL << (2U)))
  {
     
    if (USART_WaitOnFlagUntilTimeout(husart, (0x1UL << (22U)), RESET, tickstart, 1000U) != HAL_OK)
    {
...
#line 3261 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_usart.c"
...
static void USART_EndTransmit_IT(USART_HandleTypeDef *husart)
{
  ...
  (((((0x0060U) & 0x00E0U) >> 5U) == 1U)? ((husart)->Instance ->CR1 &= ~ ((uint32_t)1U << ((0x0060U) & 0x001FU))): ((((0x0060U) & 0x00E0U) >> 5U) == 2U)? ((husart)->Instance ->CR2 &= ~ ((uint32_t)1U << ((0x0060U) & 0x001FU))): ((husart)->Instance ->CR3 &= ~ ((uint32_t)1U << ((0x0060U) & 0x001FU))));
      ...
      (state == HAL_USART_STATE_BUSY_TX_RX))
  {
    *husart->pRxBuffPtr = (uint8_t)(husart->Instance->RDR & (uint8_t)uhMask);
    ...
    if (husart->RxXferCount == 0U)
    {
      ...
      ((husart->Instance ->CR1) &= ~(((0x1UL << (5U)) | (0x1UL << (8U)))));
      ...
      if (state == HAL_USART_STATE_BUSY_RX)
      {
#line 3366 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_usart.c"
      ...
      else if ((((husart->Instance ->CR1) & ((0x1UL << (6U)))) != (0x1UL << (6U))) &&
               (txdatacount == 0U))
      {
      ...
      (state == HAL_USART_STATE_BUSY_TX_RX))
  {
    ...
    *tmp = (uint16_t)(husart->Instance->RDR & uhMask);
    ...
    if (husart->RxXferCount == 0U)
    {
      ...
      if (state == HAL_USART_STATE_BUSY_RX)
      {
#line 3466 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_usart.c"
...
#line 3797 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_usart.c"
