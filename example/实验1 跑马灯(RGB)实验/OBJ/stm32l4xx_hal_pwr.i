...
#line 43 "..\\HALLIB\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_pwr.c"
...
void HAL_PWR_EnableWakeUpPin(uint32_t WakeUpPinPolarity)
{
  ...
  (((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR4)) = ((((((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR4))) & (~(((0x1FUL << (0U)) & WakeUpPinPolarity)))) | ((WakeUpPinPolarity >> 0x05)))));
...
void HAL_PWR_EnterSLEEPMode(uint32_t Regulator, uint8_t SLEEPEntry)
{
  ...
  else
  {
    ...
    if ((((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->SR2) & ((0x1UL << (9U)))) == ((0x1UL << (9U)))) == RESET)
    {
